...
{
	Lcd_cursor(&lcd,0,1);
	Lcd_string(&lcd,"deetchana\n");

	Lcd_cursor(&lcd,1,1);
	Lcd_string(&lcd,"212224220021\n");
}
...
## Output screen shots of proteus  :
 <img width="1919" height="1137" alt="image" src="https://github.com/user-attachments/assets/3b82b88c-c432-4445-9407-b0a743fbb411" />

 
 ## CIRCUIT DIAGRAM (EXPORT THE GRAPHICS TO PDF AND ADD THE SCREEN SHOT HERE): 
 <img width="1015" height="733" alt="image" src="https://github.com/user-attachments/assets/2bc19d38-622b-4262-91bf-f3ee74eaa710" />
